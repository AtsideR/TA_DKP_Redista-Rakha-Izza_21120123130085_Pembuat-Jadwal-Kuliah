...
class jadwalkuliah:
    ...
    def buat_widgets(self):
        ...
        self.menu_hari = tk.OptionMenu(self.master, self.selected_day, *self.hari)
        self.menu_hari.grid(row=5, column=1, padx=5, pady=5, sticky="w")
        self.menu_hari.config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_hari["menu"].config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        ...
        self.menu_jam_mulai = tk.OptionMenu(self.master, self.jam_mulai_var, *self.jam)
        self.menu_jam_mulai.grid(row=7, column=1, padx=5, pady=5, sticky="w")
        self.menu_jam_mulai.config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_jam_mulai["menu"].config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_menit_mulai = tk.OptionMenu(self.master, self.menit_mulai_var, *self.menit)
        self.menu_menit_mulai.grid(row=7, column=2, padx=5, pady=5, sticky="w")
        self.menu_menit_mulai.config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_menit_mulai["menu"].config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        ...
        self.menu_jam_selesai = tk.OptionMenu(self.master, self.jam_selesai_var, *self.jam)
        self.menu_jam_selesai.grid(row=8, column=1, padx=5, pady=5, sticky="w")
        self.menu_jam_selesai.config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_jam_selesai["menu"].config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_menit_selesai = tk.OptionMenu(self.master, self.menit_selesai_var, *self.menit)
        self.menu_menit_selesai.grid(row=8, column=2, padx=5, pady=5, sticky="w")
        self.menu_menit_selesai.config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
        self.menu_menit_selesai["menu"].config(bg=self.bg_color, fg=self.fg_color, font=("Arial", 10))
    ...
    def update_widgets(self):
        for widget in self.master.winfo_children():
            if isinstance(widget, tk.Label):
                ...
                widget.config(bg=self.bg_color, fg=self.fg_color)
                widget["menu"].config(bg=self.bg_color, fg=self.fg_color)
